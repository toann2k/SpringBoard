...
SELECT category, AVG(rating) as AvgRating FROM analytics GROUP BY Category ORDER BY avg DESC;
...
/* 11. Find the most out of date app. Hint: You don’t need to do it this way, but it’s 
possible to do with a subquery: http://www.postgresqltutorial.com/postgresql-max-function/ */
